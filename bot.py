...
logging.info(f"SQLite DB path: {DB_PATH}")
logging.info(f"/data exists: {os.path.exists('/data')}")
logging.info(
    f"/data contents: {os.listdir('/data') if os.path.exists('/data') else 'NO /data'}"
)
